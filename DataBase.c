...
// store parsed args to a Row data structure
...
typedef struct {
	...
	typedef struct {
    StatementType type;
	Row row_to_insert; //used  by insert statement only
} Statement;
...
#define size_of_attribute(Struct, Attribute) sizeof(((Struct*)0)->Attribute)
	...
	//where is read/write in memory fore particular row is done
	...
	//make execute_statement read/write from table structure
